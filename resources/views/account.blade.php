    ...
    <div class="avatar-section">
        <div class="avatar-wrap">
            <div class="avatar-circle" id="avatarCircle">{{ getInitials(Auth::user()->name) }}</div>
            <label class="avatar-edit" for="avatarInput">📷</label>
            <input type="file" id="avatarInput" accept="image/*" onchange="handleAvatar(this)">
        </div>
        <div class="user-name" id="displayName">{{ Auth::user()->name }}</div>
        <div class="user-email" id="displayEmail">{{ Auth::user()->email }}</div>
    </div>
        ...
        <div class="section-card">
            <div class="section-head">
                ...
                <div>
                    ...
                    <div class="section-subtitle">Nama dan Email</div>
                </div>
            </div>
        <form method="POST" action="{{ route('account.update') }}">
        @csrf
            ...
            <div class="section-body">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" placeholder="Nama depan" value="{{ old('first_name', Auth::user()->first_name) }}" required>
                    @error('first_name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" placeholder="Nama belakang" value="{{ old('last_name', Auth::user()->last_name) }}" required>
                    @error('last_name')
                        <span style="color: #ef4444;">{{ $message }}</span>
                    @enderror
                    </div>
                    <div class="form-group full">
                        <label>Email</label>
                        <input type="email" name="email" id="email" placeholder="email@contoh.com" value="{{ old('email', Auth::user()->email) }}" required>
                    @error('email')
